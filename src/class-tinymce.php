    ...
    class nK_AWB_TinyMCE {
        ...
        public function admin_enqueue_scripts ($page) {
            if ($page == "post.php" || $page == "post-new.php") {
                ...
                wp_enqueue_script('wp-color-picker-alpha', nk_awb()->plugin_url . 'assets/admin/tinymce/wp-color-picker-alpha.min.js', array('wp-color-picker'), '1.2.2');
                wp_enqueue_script('conditionize', nk_awb()->plugin_url . 'assets/admin/tinymce/conditionize.js');
