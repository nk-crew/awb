                    ...
                    '<div data-tab="awb-tab-general" class="awb-tab-active">',
                        ...
                        '<div data-cond="[name=awb_type] *= video">',
                            ...
                            '<div class="awb-col-6">',
                                ...
                                '<div class="awb-description">Start time in milliseconds when video <br> will be started (this value will be <br> applied also after loop)</div>',
                            '</div>',
                            '<div class="awb-col-6">',
                                '<h3>End Time</h3>',
                                '<input type="text" name="awb_video_end_time" value="' + atts.awb_video_end_time + '">',
                                '<div class="awb-description">End time in milliseconds when video <br> will be ended</div>',
                            '</div>',
                        '</div>',
