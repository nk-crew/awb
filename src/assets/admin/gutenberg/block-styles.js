...
const { BaseControl, PanelBody, TextControl } = wp.components;
...
const withInspectorControl = createHigherOrderComponent((OriginalComponent) => {
  class GhostkitSpacingsFallback extends Component {
    ...
    onUpdate(useSetAttributes = true) {
      ...
      const { ghostkitSpacings = {}, ghostkitClassname } = attributes;
    ...
    render() {
      ...
      return (
        <Fragment>
          <OriginalComponent {...props} {...this.state} setState={this.setState} />
...
if (!AWBData.is_ghostkit_active) {
  ...
  addFilter(
    ...
    'awb/ghostkit/spacings/additional-attributes',
    addAttribute
  );
  addFilter(
    'editor.BlockEdit',
